...
namespace {
  ...
  const DefaultColorEntry g_defaultColors[] = {
    ...
    // MTA Express buses (Bronx)
    {"MTA", "BC_BXM1",   0x0039A6, false},
    {"MTA", "BC_BXM2",   0x08179C, false},
    {"MTA", "BC_BXM18",  0x0078C6, false},

    // MTA Local buses (Bronx)
    {"MTA", "NYCT_BX10", 0x00A1DE, false},
    {"MTA", "NYCT_BX20", 0x2C7DA0, false},
  };
