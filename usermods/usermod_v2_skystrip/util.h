...
inline bool estimateTempAt(const SkyModel& m, time_t t, double step, double& outF) {
  return estimateAt(m.temperature_forecast, t, step, outF);
}
inline bool estimateDewPtAt(const SkyModel& m, time_t t, double step, double& outFdp) {
  return estimateAt(m.dew_point_forecast, t, step, outFdp);
}
inline bool estimateSpeedAt(const SkyModel& m, time_t t, double step, double& out) {
  return estimateAt(m.wind_speed_forecast, t, step, out);
}
inline bool estimateDirAt(const SkyModel& m, time_t t, double step, double& out) {
  return estimateAt(m.wind_dir_forecast, t, step, out);
}
inline bool estimateGustAt(const SkyModel& m, time_t t, double step, double& out) {
  return estimateAt(m.wind_gust_forecast, t, step, out);
}
inline bool estimateCloudAt(const SkyModel& m, time_t t, double step, double& out) {
  return estimateAt(m.cloud_cover_forecast, t, step, out);
}
inline bool estimatePrecipTypeAt(const SkyModel& m, time_t t, double step, double& out) {
  return estimateAt(m.precip_type_forecast, t, step, out);
}
inline bool estimatePrecipProbAt(const SkyModel& m, time_t t, double step, double& out) {
